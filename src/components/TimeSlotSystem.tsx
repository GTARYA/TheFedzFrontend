...
export default function ActionWindow({ address }: { address: `0x${string}` }) {
    ...
    const getTimerColor = () => {
        ...
        const totalDuration =
            currentSlot.end.getTime() - currentSlot.start.getTime();
        const elapsedTime =
            totalDuration -
            ...
            <div className="alert alert-warning">
                <svg
                    ...
                    <path
                        ...
                        strokeWidth="2"
                        d="M12 9v2m0 4h.01m-6.938 4h13.856 0 2.502-1.667 1.732-3L13.732 4c-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"
                    />
                </svg>
                <span>
                    Please connect your wallet to see your action windows.
                </span>
            </div>
        );
    }
                        ...
                        {currentSlot && remainingTime && (
                            <div className="flex flex-col items-center mt-4">
                                ...
                                <div className="grid grid-flow-col gap-4 text-center auto-cols-max pt-4">
                                    <div
                                        className={`flex flex-col p-2 ${getTimerColor()} rounded-box text-white`}>
