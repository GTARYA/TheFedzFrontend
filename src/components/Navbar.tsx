      ...
      <Container>
        <div className="flex items-center justify-between sm:h-[80px] h-[64px]">
          ...
          <ul className="items-center gap-6 text-primary hidden lg:flex">
            <li>
              <Link href="/" className="text-primary leading-6 text-[16px]">
                Home
              </Link>
            </li>
            <li>
              <Link href="/swap" className="text-primary leading-6 text-[16px]">
                Swap
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/nft" className="text-primary leading-6 text-[16px]">
                Owners
              </Link>
            </li>
            <li>
