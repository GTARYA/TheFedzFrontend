        ...
        <div className="flex flex-col md:flex-row justify-between gap-[52px]">
          <div className="max-w-full md:max-w-[300px] lg:max-w-[375px] w-full">
            ...
            <p className="mt-4 text-center md:text-left">
              Join our community and stay updated on the latest developments in
              financial stability, blockchain technology, and the future of
          ...
          <div className="flex gap-8 flex-wrap justify-center md:justify-start">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                <a href="https://blog.thefedz.org" target="_blank">
                  Blog
                </a>
                <a href="https://the-fedz.gitbook.io/the-fedz" target="_blank">
                  GitBook
                </a>
