...
import { fstocksFAQData } from "../consts/FStocksFAQ";
import {
  Disclosure,
  DisclosureButton,
  DisclosurePanel,
...
const FAQItem = ({
  ...
  return (
    <Disclosure
      ...
      className={clsx(
        "border-b",
        index + 1 === fstocksFAQData.length ? "border-none" : "border-white/10"
      )}
    >
      {({ open }) => (
        <>
...
const FStocksFAQSection = () => {
  return (
    <div className="w-full bg-white/5 rounded-lg">
      {fstocksFAQData.map((item, index) => (
      ...
      <div className="bg-[#0A0012] relative">
        ...
        <section className="relative">
          <Container className="!max-w-full !p-0">
            <div className="bg-gradient-to-b from-[#0A0012] to-[#000000] py-8 md:py-12">
              <Subtitle className="mx-auto relative z-[10]">
                Fstocks are issued by
              </Subtitle>
        ...
        <main className="relative z-[10]">
          ...
          >
            <Container>
              <Subtitle className="mx-auto">Power of FStocks</Subtitle>
              <Title className="text-center pt-1">Monetary Magic Tricks</Title>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  ...
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    Own exposure to top equities' prices like TSLA or AAPL —
                    without brokers, borders, or middlemen.
                  </p>
                </div>
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  <div className="p-5 w-[72px] h-[72px] sm:w-[100px] sm:h-[100px] flex items-center justify-center bg-[#9370DB1A] rounded-full mb-6">
                  ...
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    FStocks transform real-world prices into on-chain liquidity,
                    backed by FUSD stability mechanics.
                  </p>
                </div>
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  <div className="p-5 w-[72px] h-[72px] sm:w-[100px] sm:h-[100px] flex items-center justify-center bg-[#9370DB1A] rounded-full mb-6">
                  ...
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    Each token reflects live market behavior, enabling
                    transparent, programmable, and censorship-resistant price
                    discovery.
                  </p>
                </div>
              </div>
              ...
              <div className="overflow-hidden flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-0 justify-between min-h-[435px] px-6 lg:px-[90px] border-[1px] border-white/20 rounded-[32px] bg-[#04152F78] relative">
                ...
                >
                  ...
                  <p className="pt-4 pb-6 text-sm sm:text-base text-primary/80">
                    Our mission is to enable the broader adoption of
                    cryptocurrency by pioneering a modern fractional reserve
                    financial mechanism.
                    <br />
                    We aim to mitigate bank runs and ensure the stability of
                    FUSD with minimal capital requirements, setting a new
                    standard for financial efficiency and resilience.
                  </p>
                  <a target="_blank" href="https://Blog.TheFedz.org">
              ...
              <div className="flex items-center gap-14 justify-between text-primary relative z-[5]">
                ...
                <div id="how-it-works">
                  ...
                  <Title className="text-center lg:text-left">
                    Exclusive Access, Stake Collateral, Earn Profits
                  </Title>
                  <p className="py-4 text-sm sm:text-base lg:max-w-[90%] text-center lg:text-left">
                    Profit while helping secure long-term financial stability in
                    The Fedz ecosystem.
                  </p>
                  ...
                  <ul className="flex flex-col gap-4 mb-6 order-4">
                    <li className="flex gap-[14px]">
                      ...
                      <div>
                        <h4 className="text-base sm:text-xl mb-[10px] font-semibold">
                          Grant exclusive access to the Private Liquidity Pool
                        </h4>
                        <p className="text-sm sm:text-base opacity-80">
                          Owning a Fedz NFT grants exclusive access to the
                          Private Liquidity Pool, allowing you to engage in
                          profitable activities like arbitrage and liquidity
                    ...
                    <li className="flex gap-[14px]">
                      ...
                      <div>
                        <h4 className="text-base sm:text-xl mb-[10px] font-semibold">
                          Swap to Stabilize and Share Access
                        </h4>
                        <p className="text-sm sm:text-base opacity-80">
                          Take your turn in the Private Liquidity Pool and
                          perform key actions like asset swaps to reinforce the
                          system's stability. Participation fuels a balanced
                          ecosystem while unlocking tangible rewards and
                    ...
                    <li className="flex gap-[14px]">
                      ...
                      <div>
                        <h4 className="text-base sm:text-xl mb-[10px] font-semibold">
                          Earn Profits While Securing Financial Stability
                        </h4>
                        <p className="text-sm sm:text-base opacity-80">
                          By making strategic choices and participating
                          actively, you can earn profits while helping to secure
                          the system's long-term financial stability,
                          contributing to a balanced and robust game economy.
                        </p>
                      </div>
                    </li>
                  </ul>
            ...
            <Container className="relative z-[5]">
              ...
              <div className="mt-8 p-6 rounded-[32px] border-[1px] border-white/20 bg-white/5">
                ...
                <p className="text-primary text-sm md:text-base">
                  ...
                  are experimental liquidity protocols studying stability under
                  stress. They may fail, depeg, or explode — by design. If that
                  excites you, welcome to the experiment. If that scares you,
          ...
          <section className="relative py-[50px] md:py-[75px] bg-gradient-to-b from-[#0A0012] to-[#0A0012] via-[#04152F78]">
            <Container className="relative z-[5]">
              <div className="relative z-[5]">
                <Subtitle className="mb-1">Build with Confidence</Subtitle>
                ...
                <div className="relative overflow-hidden rounded-[32px] border-[1px] border-white/20 bg-white/5 w-full pb-[42px] pt-5">
                  <table className="table w-full text-sm md:text-xl text-primary">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td className="pt-4 px-8 align-top">Description</td>
                        <td className="pt-4 px-8">
                          A Uniswap v4 Hook that implements a gamified
                          experienced for Swappers and LPs, with NFT-restricted
                          access and Turn Based Logic for the pool actions.
                        </td>
                      </tr>
                    </tbody>
                  </table>
