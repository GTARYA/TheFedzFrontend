    ...
    <>
      ...
      <div className="bg-[#0A0012] relative">
            ...
            <section className="max-w-[1050px] mx-auto md:mt-[10px] mt-[56px]">
              {isNormalMode ? (
                <h1 className="text-primary md:leading-[72px] md:font-extrabold font-bold md:text-[60px] text-center mb-4 leading-[40px] text-[34px]">
                  FUSD{" "}
                  <span data-text="Stable" className="neon-text font-semibold">
                    Stable
                  </span>{" "}
                  Coin
                </h1>
        ...
        <main className="relative z-[10]">
          ...
          >
            <Container>
              <Subtitle className="mx-auto">Strengths of The Fedz</Subtitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  ...
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    Implement proven mechanisms to mitigate the risk of panic
                    withdrawals and ensure the security of users' assets.
                  </p>
                </div>
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  <div className="p-5 w-[72px] h-[72px] sm:w-[100px] sm:h-[100px] flex items-center justify-center bg-[#9370DB1A] rounded-full mb-6">
                  ...
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    Modified structures of an AMM designed to enable issuers to
                    demonstrate their financial trust, offering enhanced
                ...
                <div className="bg-white/10 rounded-[24px] p-5 md:p-6 text-primary">
                  ...
                  <h3 className="font-semibold text-xl sm:text-2xl">FUSD</h3>
                  <p className="pt-2 text-sm md:text-base md:leading-6">
                    A stablecoin backed by undercollateralized assets designed
                    to maintain a stable value while minimizing capital
                    requirements, and introduced as our first financial product
                    to demonstrate stability and mitigate bank runs within The
                    Fedz ecosystem.
                  </p>
                </div>
              </div>
